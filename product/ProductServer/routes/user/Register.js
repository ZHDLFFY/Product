...
router.post('/:value', (req, res) => {                                                //注册请求
    ...
    let creatTable = "CREATE TABLE " + data.username + 'table' + "(id INT NOT NULL AUTO_INCREMENT ,ProductId VARCHAR(255) NOT NULL,ProductName VARCHAR(255)  NOT NULL,HaveNumber VARCHAR(255) ,Date VARCHAR(255) NOT NULL,PRIMARY KEY ( id))ENGINE=InnoDB DEFAULT CHARSET=utf8;"
